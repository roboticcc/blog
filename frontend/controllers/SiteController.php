    ...
    public function actionSignup()
    {
        ...
        if ($form->load(Yii::$app->request->post()) && $form->validate()) {
            ...
            try{
                ...
                $signupService->sentEmailConfirmation($user);
                return $this->goHome();
...
////
////        $bannedUser = Yii::$app->authManager->createRole('banned_user');
////        $bannedUser->description = 'Забаненный пользователь';
////        Yii::$app->authManager->add($bannedUser);
////
////        $permit = Yii::$app->authManager->createPermission('isAdmin');
////        $permit->description = 'неограниченный доступ к админке';
////        Yii::$app->authManager->add($permit);
////
////        $admin = Yii::$app->authManager->getRole('admin');
////        $permission = Yii::$app->authManager->getPermission('isAdmin');
////        Yii::$app->authManager->addChild($admin, $permission);
//
